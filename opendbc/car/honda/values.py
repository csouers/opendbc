...
class CAR(Platforms):
  ...
  HONDA_CIVIC_2022 = HondaBoschPlatformConfig(
    ...
    HONDA_CIVIC_BOSCH.specs,
    dbc_dict('honda_civic_ex_2022_can_generated', None, body_dbc='honda_body_2017_generated'),
  ...
  ACURA_RDX_3G = HondaBoschPlatformConfig(
    ...
    dbc_dict('acura_rdx_2020_can_generated', None, body_dbc='honda_body_2017_generated'),
    flags=HondaFlags.BOSCH_ALT_BRAKE,
  )
  HONDA_INSIGHT = HondaBoschPlatformConfig(
    ...
    dbc_dict('honda_insight_ex_2019_can_generated', None, body_dbc='honda_body_2017_generated'),
  )
  ...
  ACURA_ILX = HondaNidecPlatformConfig(
    ...
    dbc_dict('acura_ilx_2016_can_generated', 'acura_ilx_2016_nidec', body_dbc='honda_body_2017_generated'),
  ...
  HONDA_CRV = HondaNidecPlatformConfig(
    ...
    dbc_dict('honda_crv_touring_2016_can_generated', 'acura_ilx_2016_nidec', body_dbc='honda_body_2017_generated'),
    flags=HondaFlags.NIDEC_ALT_SCM_MESSAGES,
  )
  HONDA_CRV_EU = HondaNidecPlatformConfig(
    [],  # Euro version of CRV Touring, don't show in docs
    HONDA_CRV.specs,
    dbc_dict('honda_crv_executive_2016_can_generated', 'acura_ilx_2016_nidec', body_dbc='honda_body_2017_generated'),
    flags=HondaFlags.NIDEC_ALT_SCM_MESSAGES,
  )
  HONDA_FIT = HondaNidecPlatformConfig(
    ...
    dbc_dict('honda_fit_ex_2018_can_generated', 'acura_ilx_2016_nidec', body_dbc='honda_body_2017_generated'),
    flags=HondaFlags.NIDEC_ALT_SCM_MESSAGES,
  )
  ...
  HONDA_ODYSSEY = HondaNidecPlatformConfig(
    ...
    dbc_dict('honda_odyssey_exl_2018_generated', 'acura_ilx_2016_nidec', body_dbc='honda_body_2017_generated'),
  ...
  ACURA_RDX = HondaNidecPlatformConfig(
    ...
    dbc_dict('acura_rdx_2018_can_generated', 'acura_ilx_2016_nidec', body_dbc='honda_body_2017_generated'),
    flags=HondaFlags.NIDEC_ALT_SCM_MESSAGES,
  )
  ...
  HONDA_CIVIC = HondaNidecPlatformConfig(
    ...
    dbc_dict('honda_civic_touring_2016_can_generated', 'acura_ilx_2016_nidec', body_dbc='honda_body_2017_generated'),
  )
