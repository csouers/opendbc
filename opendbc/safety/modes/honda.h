...
static void honda_rx_hook(const CANPacket_t *msg) {
  ...
  if (((msg->addr == 0x326U) && (msg->bus == pt_bus)) || (msg->addr == 0x1A6U)) {
...
static bool honda_tx_hook(const CANPacket_t *msg) {
  ...
  if (msg-> addr == 0x16F118F0U){
    bool signalCmd = ((GET_LEN(msg) == 8U) && ((GET_BYTES(msg, 0, 4) == 0x000F0A30U) || (GET_BYTES(msg, 0, 4) == 0x000F0B30U) || (GET_BYTES(msg, 0, 4) == 0x000F2030U)) && (GET_BYTES(msg, 4, 4) == 0x0U));
    bool fogCmd = ((GET_LEN(msg) == 8U) && (GET_BYTES(msg, 0, 4) == 0x000F2030U) && (GET_BYTES(msg, 4, 4) == 0x0U));
...
static safety_config honda_nidec_init(uint16_t param) {
  ...
  static CanMsg HONDA_N_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = true}, {0x194, 0, 4, .check_relay = true}, {0x1FA, 0, 8, .check_relay = false},
                                     ...
                                     {0x16F118F0, 0, 8, .check_relay = false}, {0x16F118F0, 0, 1, .check_relay = false}};
...
static safety_config honda_bosch_init(uint16_t param) {
  static CanMsg HONDA_BOSCH_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = true}, {0xE5, 0, 8, .check_relay = true}, {0x296, 1, 4, .check_relay = false},
                                         ...
                                         {0x16F118F0, 0, 8, .check_relay = false}, {0x16F118F0, 0, 1, .check_relay = false}};  // Bosch};  // Bosch};  // Bosch

  static CanMsg HONDA_BOSCH_LONG_TX_MSGS[] = {{0xE4, 1, 5, .check_relay = false}, {0x1DF, 1, 8, .check_relay = false}, {0x1EF, 1, 8, .check_relay = false},
                                              ...
                                              {0x16F118F0, 0, 8, .check_relay = false}, {0x16F118F0, 0, 1, .check_relay = false}};  // Bosch w/ gas and brakes

  static CanMsg HONDA_RADARLESS_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = true}, {0x296, 2, 4, .check_relay = false}, {0x33D, 0, 8, .check_relay = true},
  {0x16F118F0, 0, 8, .check_relay = false}, {0x16F118F0, 0, 1, .check_relay = false}};  // Bosch radarless
  ...
  static CanMsg HONDA_RADARLESS_LONG_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = true}, {0x33D, 0, 8, .check_relay = true}, {0x1C8, 0, 8, .check_relay = true},
                                                  {0x30C, 0, 8, .check_relay = true},                                      {0x16F118F0, 0, 8, .check_relay = false}, {0x16F118F0, 0, 1, .check_relay = false}};  // Bosch radarless w/ gas and brakes
