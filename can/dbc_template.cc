  ...
  {% for sig in sigs %}
    {
      ...
      {% elif address in [512, 513, 2049, 2050] and sig.name == "CHECKSUM_COMMA" %}
      .type = SignalType::COMMA_CHECKSUM,
      {% elif address in [512, 513, 2049, 2050] and sig.name == "COUNTER_COMMA" %}
      .type = SignalType::COMMA_COUNTER,
      {% else %}
